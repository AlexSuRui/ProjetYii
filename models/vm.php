...
class vm extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['vm_name', 'vm_host_name', 'vm_state', 'vm_family', 'vm_guest_full_name', 'vm_guest_id', 'vm_hardware_version', 'vm_tools_status','vm_tools_version', 'vm_tools_version_status', 'vm_name_check', 'vm_compliance_check', 'VMCountryCode'], 'string', 'max' => 100],
            [['vm_ip'], 'string', 'max' => 50],
